...
public class User extends AbstractDomainObject implements Serializable, IActivityStatus, IUser
{
     ...
     */
    /*
     * Don't use this in Acquire, and it causes deadlocks.
     */
   // protected Collection<Site> siteCollection = new HashSet<Site>();
     ...
     */
    protected Collection<Password> passwordCollection = new HashSet<Password>();
     ...
     */
    public void setCollectionProtocolCollection(final Collection<CollectionProtocol> collectionProtocolCollection)
    {
     ...
     *            of Collection type.
     */
    public void setPasswordCollection(final Collection<Password> passwordCollection)
    {
    ...
    public void setAllValues(final IValueObject abstractForm) throws AssignDataException
    {
        try
        {
            ...
            else
            {
                ...
                if (!pageOf.equals(Constants.PAGE_OF_SIGNUP) && !pageOf.equals(Constants.PAGE_OF_USER_PROFILE))
                {
    ...
    public String getLatestPassword()
    {
        ...
        if (pwdList != null)
        {
            ...
            if (!pwdList.isEmpty())
            {
                password =  pwdList.get(0).getPassword();
            }
        }
        return password;
    }
     ...
     */
    public void setAssignedProtocolCollection(final Collection<CollectionProtocol> userCollectionProtocolCollection)
    {
    ...
    */
    ...
    {
        this.siteCollection.addAll(siteCollection);;
    }
    */
     ...
     *
     * @param arg0
     *            If user is Administrator, True/False
     */
    public void setAdminuser(final Boolean arg0)
    {
        throw new UnsupportedOperationException("Un-Implemented method");
    }
