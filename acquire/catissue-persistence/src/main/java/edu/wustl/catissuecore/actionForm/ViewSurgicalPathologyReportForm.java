...
public class ViewSurgicalPathologyReportForm extends AbstractActionForm
{
	 ...
	 */
	public void setDeIdentifiedReport(
			final DeidentifiedSurgicalPathologyReport deidentifiedSurgicalPathologyReport)
	{
		try
		{
			...
			{
				this.deIdentifiedReportTextContent = deidentifiedSurgicalPathologyReport
	...
	public void setParticipant(final Participant participant)
	{
		...
		try
		{
			...
			final Collection<Race> tempRaceColl = participant.getRaceCollection();
			final Iterator<Race> raceIter = tempRaceColl.iterator();
			this.race = "";
			final StringBuffer tempStr = new StringBuffer();
			while (raceIter.hasNext())
			{
				tempStr.append(raceIter.next().getRaceName() + ", ");
			}
