			...
			Serializable
{
	...
	public void setConsentTierStatusCollectionFromCPR(
			CollectionProtocolRegistration collectionProtocolRegistration)
	{
		Collection<ConsentTierStatus> consentTierStatusCollectionN = this.getConsentTierStatusCollection();
		...
		final Collection<ConsentTierStatus> scgConsTierColl = this.getConsentTierStatusCollection();
